...
<Box id={styles.left}>
          ...
          <Text>{user1[0].address.name}</Text>
          <Flex justifyContent="center">
           <Text mr={"10px"}>{user1[0].address.building}</Text>
           <Text>{user1[0].address.area}</Text>
          </Flex>          
          <Flex justifyContent="center">
           <Text mr={"10px"}>{user1[0].address.city}</Text>
           <Text>{user1[0].address.state}</Text>
          </Flex>
